...
agent_groups = {'cyware-agent1': ['default', 'test_mg_0'],
                'cyware-agent2': ['default', 'test_mg_1']}
test_infra_agents = ['cyware-agent1', 'cyware-agent2']

shared_folder_path = os.path.join(CYWARE_PATH, 'etc', 'shared')
mg_folder_path = os.path.join(CYWARE_PATH, 'var', 'multigroups')

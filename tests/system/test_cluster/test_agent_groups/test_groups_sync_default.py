...
os_version:
    ...
    - Red Hat 6
references:
    - https://github.com/cyware/cyware-qa/issues/2514
tags:
    - cyware-db
'''
import os
...
def test_agent_groups_sync_default(agent_host, clean_environment):
    ...
    seconds, during 400 seconds. After all agents have been registered, it is checked that the cywareDB has been synched

...
These tests are not part of the current testing framework for Cyware, so they have to be executed manually. The necessary
...
in [How SCA works](https://documentation.cyware.khulnasoft.com/4.2/user-manual/capabilities/sec-config-assessment/how_it_works.html)
. Also, there is a blog post
about [Security Configuration Assessment](https://cyware.khulnasoft.com/blog/security-configuration-assessment/).
...
of the process in the [Installation Guide](https://documentation.cyware.khulnasoft.com/4.0/installation-guide/index.html).

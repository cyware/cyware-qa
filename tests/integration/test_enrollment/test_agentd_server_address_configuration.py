...
references:
    - https://documentation.cyware.khulnasoft.com/current/user-manual/reference/ossec-conf/client.html#address
...
from cyware_testing.agent import callback_connected_to_manager_ip, callback_invalid_server_address, \
                                callback_could_not_resolve_hostname, CLIENT_KEYS_PATH
from cyware_testing.tools import HOSTS_FILE_PATH
...
from cyware_testing.tools.monitoring import DEFAULT_WAIT_FILE_TIMEOUT
...
daemons_handler_configuration = {'daemons': ['cyware-agentd'], 'ignore_errors': True}
...
parameters = [
    ...
    {'SERVER_ADDRESS': 'cyware-manager-ipv4'},         # Resolve hostname, valid IP, unable to connect (IPv4)
    {'SERVER_ADDRESS': 'cyware-manager-ipv6'},         # Resolve hostname, valid IP, unable to connect (IPv6 compressed)
]
...
metadata = [
    ...
    {'server_address': 'cyware-manager-ipv4', 'host_ip': '127.0.0.1', 'expected_connection': True},
    {'server_address': 'cyware-manager-ipv6', 'host_ip': '::1', 'expected_connection': True, 'ipv6': True}
]

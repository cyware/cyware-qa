...
from cyware_testing.tools import CYWARE_PATH, CLIENT_KEYS_PATH, get_version
...
from cyware_testing.tools.configuration import load_cyware_configurations, set_section_cyware_conf, write_cyware_conf
...
AUTHDPASS_PATH = os.path.join(CYWARE_PATH, folder, 'authd.pass')
SERVER_KEY_PATH = os.path.join(CYWARE_PATH, folder, 'manager.key')
SERVER_CERT_PATH = os.path.join(CYWARE_PATH, folder, 'manager.cert')
SERVER_PEM_PATH = os.path.join(CYWARE_PATH, folder, 'manager.pem')
AGENT_KEY_PATH = os.path.join(CYWARE_PATH, folder, 'agent.key')
AGENT_CERT_PATH = os.path.join(CYWARE_PATH, folder, 'agent.cert')
AGENT_PEM_PATH = os.path.join(CYWARE_PATH, folder, 'agent.pem')
...
@pytest.fixture(scope='function')
def override_cyware_conf(get_current_test_case, request):
    """

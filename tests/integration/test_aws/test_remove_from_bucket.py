...
import pytest
from cyware_testing import TEMPLATE_DIR, TEST_CASES_DIR, global_parameters
from cyware_testing.modules.aws import event_monitor, local_internal_options  # noqa: F401
from cyware_testing.modules.aws.cloudwatch_utils import log_stream_exists
from cyware_testing.modules.aws.s3_utils import file_exists
...
def test_remove_from_bucket(
    configuration, metadata, mark_cases_as_skipped, upload_and_delete_file_to_s3, load_cyware_basic_configuration,
    set_cyware_configuration, clean_s3_cloudtrail_db, configure_local_internal_options_function,
    truncate_monitored_files, restart_cyware_function, file_monitoring
):
    """
...
def test_remove_log_stream(
    configuration, metadata, create_log_stream, load_cyware_basic_configuration, set_cyware_configuration,
    clean_aws_services_db, configure_local_internal_options_function, truncate_monitored_files, restart_cyware_function,
    file_monitoring
):
    """

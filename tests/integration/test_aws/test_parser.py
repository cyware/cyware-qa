...
def test_bucket_and_service_missing(
    configuration, metadata, load_cyware_basic_configuration, set_cyware_configuration,
    configure_local_internal_options_function, truncate_monitored_files, restart_cyware_function_without_exception,
    file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_cyware_function_without_exception:
            type: fixture
            brief: Restart the cyware service catching the exception.
        - file_monitoring:
            type: fixture

...
brief: The Cyware 'office365' module allows you to collect all the logs from Office 365 using its API.
...
references:
    - https://github.com/cyware/cyware-documentation/blob/develop/source/office365/index.rst
    - https://github.com/cyware/cyware-documentation/blob/develop/source/office365/monitoring-office365-activity.rst
'''
import os
import sys
...
from cyware_testing.office365 import callback_detect_enabled_err, callback_detect_only_future_events_err, \
...
def test_invalid(get_local_internal_options, configure_local_internal_options,
    ...
    input_description: A configuration template (offic365_integration) is contained in an external YAML file
                       (cyware_conf.yaml). That template is combined with different test cases defined in

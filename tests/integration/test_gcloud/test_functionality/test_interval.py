...
references:
    - https://documentation.cyware.khulnasoft.com/current/user-manual/reference/ossec-conf/gcp-pubsub.html#interval
...
from cyware_testing.gcloud import callback_detect_start_fetching_logs, callback_detect_start_gcp_sleep

...
from cyware_testing.gcloud import callback_detect_gcp_alert, validate_gcp_event, publish_sync
...
def test_rules(get_configuration, configure_environment,
    ...
    for line in events_file:
        ...
        event = cyware_log_monitor.start(timeout=global_parameters.default_timeout + time_interval + 100,

...
```shell script
<gcp-pubsub>
  <project_id>cyware-project-123</project_id>
  <subscription_name>cyware-integration</subscription_name>
...
```shell script
# Enable debug 2
echo 'cyware_modules.debug=2' >> $cyware_path/etc/local_internal_options.conf
echo 'analysisd.debug=2' >> $cyware_path/etc/local_internal_options.conf
...
# Enable debug 2
echo 'cyware_modules.debug=2' >> /Library/Ossec/etc/local_internal_options.conf
...
```shell script
python3 -m pytest -vvx --gcp-project-id=cyware-project-123 --gcp-subscription-name=cyware-integration --gcp-credentials-file=credentials.json test_gcloud/test_functioning/test_pull_on_start.py
...
rootdir: /home/daniel/Cyware/cyware-qa/tests/integration, inifile: pytest.ini

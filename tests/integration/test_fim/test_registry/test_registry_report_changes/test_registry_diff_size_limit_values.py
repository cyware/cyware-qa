...
from cyware_testing.modules.fim.utils import (registry_value_create, registry_value_update, registry_value_delete,
...
configurations_path = os.path.join(test_data_path, 'cyware_registry_diff_size_limit_values.yaml')
...
def test_diff_size_limit_values(key, subkey, arch, value_name, size, get_configuration, configure_environment,
    ...
    '''
    description: Check if the 'cyware-syscheckd' daemon limits the size of the monitored value to generate

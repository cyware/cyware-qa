...
from cyware_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, MONITORED_KEY_2,
...
def test_disk_quota_values(key, subkey, arch, value_name, size, get_configuration, configure_environment,
    ...
    """
    description: Check if the 'cyware-syscheckd' daemon limits the size of the folder where the data used

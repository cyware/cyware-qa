...
import pytest
from cyware_testing import global_parameters, LOG_FILE_PATH
...
from cyware_testing.modules.fim.event_monitor import (callback_detect_end_scan, CB_REGISTRY_LIMIT_CAPACITY,
...
from cyware_testing.modules.fim.utils import (generate_params, modify_registry_value, wait_for_scheduled_scan,
...
def test_registry_limit_capacity_alert(percentage, get_configuration, configure_local_internal_options_module,
    ...
    if percentage >= 80:  # Percentages 80 and 90
        ...
        wait_for_scheduled_scan(wait_for_scan=True, interval=scan_delay, monitor=cyware_log_monitor)
    ...
    value_entries = cyware_log_monitor.start(timeout=global_parameters.default_timeout,

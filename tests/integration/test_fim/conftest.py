...
from cyware_testing import (global_parameters, LOG_FILE_PATH, REGULAR, CYWARE_SERVICES_START, CYWARE_SERVICES_STOP,
                           CYWARE_LOG_MONITOR)
from cyware_testing.tools.services import control_service
from cyware_testing.tools.monitoring import FileMonitor
from cyware_testing.tools.file import truncate_file, delete_path_recursively, create_file
from cyware_testing.tools.local_actions import run_local_command_returning_output
from cyware_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, SYNC_INTERVAL_VALUE, KEY_WOW64_64KEY,
                                       MONITORED_DIR_1, registry_parser)
from cyware_testing.modules.fim import event_monitor as evm
from cyware_testing.modules.fim.utils import create_registry, delete_registry

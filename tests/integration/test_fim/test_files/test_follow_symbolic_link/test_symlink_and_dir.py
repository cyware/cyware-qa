...
def test_symlink_dir_inside_monitored_dir(tags_to_apply, get_configuration, configure_environment, restart_syscheckd,
                                          wait_for_fim_start):
    '''
    description: Check if the 'cyware-syscheckd' daemon detects events from existing files in a new target
    ...
    input_description: A test case (symlink_and_dir) is contained in external YAML file (cyware_conf.yaml)

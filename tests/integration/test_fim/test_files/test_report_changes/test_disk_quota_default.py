...
from cyware_testing.modules.fim.event_monitor import CB_DISK_QUOTA_LIMIT_CONFIGURED_VALUE, ERR_MSG_DISK_QUOTA_LIMIT
...
def test_disk_quota_default(get_configuration, configure_environment,
    ...
    '''
    description: Check if the 'cyware-syscheckd' daemon limits the size of the folder where the data used to perform
    ...
    disk_quota_value = cyware_log_monitor.start(

...
import pytest
from cyware_testing import LOG_FILE_PATH, T_10, T_60
...
from cyware_testing.modules.fim.event_monitor import check_fim_event, CB_FIM_PATH_CONVERTED
...
def test_windows_system_monitoring(configuration, metadata, test_folders, set_cyware_configuration,
                                   create_monitored_folders_module, configure_local_internal_options_function,
                                   restart_syscheck_function, wait_syscheck_start):
    '''
    description: Check if the 'cyware-syscheckd' monitors the windows system folders (System32 and SysWOW64) properly,
    ...
    regular_file_cud(folder, cyware_log_monitor, file_list=file_list, min_timeout=T_60, triggers_event=True,
                     escaped=True)

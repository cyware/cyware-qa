...
import pytest
from cyware_testing import T_30, LOG_FILE_PATH
...
def test_tags(folder, name, content,
    ...
    '''
    description: Check if the 'cyware-syscheckd' daemon generates the tags required for each event
    ...
    input_description: A test case is contained in external YAML file (cyware_conf.yaml) which
                       includes configuration settings for the 'cyware-syscheckd' daemon and,
    ...
    regular_file_cud(folder, cyware_log_monitor, file_list=files, min_timeout=T_30,

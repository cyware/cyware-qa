...
import pytest
from cyware_testing import LOG_FILE_PATH, REGULAR, T_10
from cyware_testing.tools import PREFIX
from cyware_testing.modules.fim.event_monitor import CB_IGNORING_DUE_TO_SREGEX, CB_IGNORING_DUE_TO_PATTERN
...
def test_ignore_works_over_restrict(configuration, metadata, set_cyware_configuration, test_folders,
    ...
    matching_log = cyware_log_monitor.start(timeout=T_10, accum_results=2, callback=generate_monitoring_callback(regex),

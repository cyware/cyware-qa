...
from cyware_testing import LOG_FILE_PATH, CIS_RULESET_PATH
from cyware_testing.modules import sca
from cyware_testing.modules.sca import event_monitor as evm
from cyware_testing.tools.file import copy, delete_file, copy_files_in_folder, delete_path_recursively
...
def wait_for_sca_enabled():
    ...
    evm.check_sca_enabled(cyware_monitor)

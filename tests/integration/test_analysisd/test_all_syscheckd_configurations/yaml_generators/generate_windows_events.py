...
from cyware_testing.fim import REGULAR, create_file, modify_file, delete_file, callback_detect_event
from cyware_testing.tools import CYWARE_CONF, PREFIX, LOG_FILE_PATH
...
def configure_syscheck_environment(time_sleep):
    ...
    try:
        while True:
            cyware_log_monitor.start(timeout=5, callback=callback_detect_event)
    except TimeoutError:
        pass

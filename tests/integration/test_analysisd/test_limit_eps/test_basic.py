...
def test_enabled(configuration, metadata, load_cyware_basic_configuration, set_cyware_configuration,
...
def test_disabled(configuration, metadata, load_cyware_basic_configuration, set_cyware_configuration,
                  configure_local_internal_options_function, truncate_monitored_files, restart_cyware_daemon_function):
    """

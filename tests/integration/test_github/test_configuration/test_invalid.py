...
brief: The Cyware 'github' module allows you to collect all the 'audit logs' from GitHub using its API.
...
references:
    - https://github.com/cyware/cyware-documentation/blob/develop/source/github/monitoring-github-activity.rst
...
from cyware_testing.github import callback_detect_enabled_err, callback_detect_only_future_events_err, \

...
brief: This module verifies the correct behavior of the enrollment daemon 'cyware-authd' under different messages.
...
import pytest
from cyware_testing.tools import CYWARE_DB_SOCKET_PATH
...
# Variables
log_monitor_paths = []
receiver_sockets_params = [(("localhost", 1515), 'AF_INET', 'SSL_TLSv1_2'), (CYWARE_DB_SOCKET_PATH, 'AF_UNIX', 'TCP')]
...
def test_ossec_auth_messages_with_key_hash(configure_environment, configure_sockets_environment,
                                           ...
                                           restart_cyware_daemon_function, wait_for_authd_startup_function,
    ...
    parameters:
        ...
        - restart_cyware_daemon_function:
            type: fixture
            brief: Restarts cyware or a specific daemon passed.

...
brief: These tests will check if the 'cyware-authd' daemon correctly responds to the enrollment requests
...
from cyware_testing.authd import create_authd_request, validate_authd_response, validate_authd_logs, \
...
monitored_sockets_params = [('cyware-authd', None, True), ('cyware-db', None, True)]

...
brief: These tests will check that the settings related to the API host address and listening port
       are working correctly. The Cyware API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.cyware.khulnasoft.com/current/user-manual/api/configuration.html#api-configuration-options

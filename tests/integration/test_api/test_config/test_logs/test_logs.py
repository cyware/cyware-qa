...
brief: These tests will check if the 'level' setting of the API is working properly. This setting
       ...
       The Cyware API is an open source 'RESTful' API that allows for interaction with the Cyware manager
...
references:
    ...
    - https://documentation.cyware.khulnasoft.com/current/user-manual/api/configuration.html#logs

...
brief: These tests will check if the response_postprocessing middleware of the API handled by the 'cyware-apid' daemon is
       working properly. The Cyware API is an open source 'RESTful' API that allows for interaction with the Cyware

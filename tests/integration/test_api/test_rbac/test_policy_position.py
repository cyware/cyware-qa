...
references:
    ...
    - https://documentation.cyware.khulnasoft.com/current/user-manual/api/reference.html#tag/Security
...
import pytest
import requests
from cyware_testing.api import get_security_resource_information

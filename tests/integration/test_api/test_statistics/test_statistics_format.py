...
from cyware_testing.api import make_api_call
...
from cyware_testing.tools.file import read_json_file
...
def test_manager_statistics_format(configuration, metadata, load_cyware_basic_configuration, set_cyware_configuration,
                                   get_api_details, restart_cyware_daemon_function):
    """
    ...
    parameters:
        ...
        - restart_cyware_daemon_function:
            type: fixture
            brief: Restart the cyware service and truncate cyware logs.
...
def test_agent_statistics_format(metadata, restart_cyware_daemon_function, get_api_details):
    """
    description: Check if the statistics returned by the API have the expected format.

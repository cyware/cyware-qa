...
from cyware_testing.tools import CYWARE_PATH, get_version
...
def set_ar_conf_mode():
    ...
    local_int_conf_path = os.path.join(CYWARE_PATH, folder, 'ar.conf')
    debug_line = "restart-cyware0 - restart-cyware - 0\nrestart-cyware0 - restart-cyware.exe - 0\n" \
...
def set_debug_mode():
    ...
    local_int_conf_path = os.path.join(CYWARE_PATH, folder, 'local_internal_options.conf')

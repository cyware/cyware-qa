...
def test_load_rules_decoders(restart_required_logtest_daemons, wait_for_logtest_startup, test_case):
    '''
    description: Check if 'cyware-logtest' does produce the right decoder/rule matching when processing a log under
    ...
    if 'local_rules' in test_case:
        ...
        shutil.chown('/var/ossec/etc/rules/local_rules.xml', "cyware", "cyware")
    ...
    if 'local_decoders' in test_case:
        ...
        shutil.chown('/var/ossec/etc/decoders/local_decoder.xml', "cyware", "cyware")

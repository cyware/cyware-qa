...
from cyware_testing.cyware_db import query_wdb, insert_agent_in_db, remove_agent
...
def test_get_groups_integrity(test_case, create_groups):
    '''
    description: Check that every input message using the 'get-groups-integrity' command in cyware-db socket generates

...
brief: The 'cyware-logcollector' daemon monitors configured files and commands for new log messages.
       ...
       correctly executed by the logcollector, and the Cyware API returns the same values for
...
def test_configuration_command(configure_local_internal_options_module, get_configuration,
    ...
    '''
    description: Check if the 'cyware-logcollector' daemon can monitor commands that use multiple parameters.

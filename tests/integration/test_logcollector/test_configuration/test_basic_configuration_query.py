...
cyware_configuration = 'cyware_basic_configuration_query_macos.yaml'
...
if sys.platform != 'win32' and sys.platform != 'darwin':
    ...
    if sys.platform == 'darwin':
        ...
        cyware_configuration = 'cyware_basic_configuration_query_windows.yaml'
...
configurations_path = os.path.join(test_data_path, cyware_configuration)
...
def test_configuration_query_valid(get_configuration, configure_environment, restart_logcollector):
    '''
    description: Check if the 'cyware-logcollector' daemon starts properly when the 'query' tag is used.
    ...
    input_description: A configuration template (test_basic_configuration_query_macos and
                       ...
                       (cyware_basic_configuration_query_macos.yaml and cyware_basic_configuration_query_windows.yaml).
                       Those templates are combined with different test cases defined in the module. Those include
                       configuration settings for the 'cyware-logcollector' daemon.

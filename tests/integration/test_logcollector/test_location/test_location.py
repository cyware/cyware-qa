...
file_structure = [
    ...
    {
        'folder_path':  os.path.join(temp_dir, 'cyware-testing', 'depth1'),
        'filename': ['depth_test.txt'],
        'content': f'Content of testing_file\n'
    },
    {
        'folder_path': os.path.join(temp_dir, 'cyware-testing', 'depth1', 'depth2'),
        'filename': ['depth_test.txt'],
        'content': f'Content of testing_file\n'
    },
    {
        'folder_path': os.path.join(temp_dir, 'cyware-testing', 'duplicated'),
        'filename': ['duplicated.txt'],
        'content': f'Content of testing_file\n'
    },
    {
        'folder_path': os.path.join(temp_dir, 'cyware-testing', 'multiple-logs'),
        'filename': [],
        'content': f'Content of testing_file\n'
    }
]
...
parameters = [
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'depth1', 'test.txt'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'depth1', ' depth_test.txt'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'depth1', 'depth2', 'depth_test.txt'),
     'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'non-existent.txt'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', '*'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'Testing white spaces'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'test.*'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'c*test.txt'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'duplicated', 'duplicated.txt'),
     'LOG_FORMAT': 'syslog', 'PATH_2': os.path.join(temp_dir, 'cyware-testing', 'duplicated', 'duplicated.txt')},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', r'file.log-%Y-%m-%d'), 'LOG_FORMAT': 'syslog'},
    {'LOCATION': os.path.join(temp_dir, 'cyware-testing', 'multiple-logs', '*'), 'LOG_FORMAT': 'syslog'}
]

metadata = [
    {'location': os.path.join(temp_dir, 'cyware-testing', 'depth1', 'test.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'depth1', 'test.txt')],
     'log_format': 'syslog', 'file_type': 'single_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'depth1', ' depth_test.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'depth1', ' depth_test.txt')],
     'log_format': 'syslog', 'file_type': 'single_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'depth1', 'depth2', 'depth_test.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'depth1', 'depth2', 'depth_test.txt')],
     'log_format': 'syslog', 'file_type': 'single_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'non-existent.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'non-existent.txt')],
     'log_format': 'syslog', 'file_type': 'non_existent_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', '*'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'foo.txt'),
               os.path.join(temp_dir, 'cyware-testing', 'bar.log'),
               os.path.join(temp_dir, 'cyware-testing', 'test.yaml'),
               os.path.join(temp_dir, 'cyware-testing', 'ñ.txt')],
     'log_format': 'syslog', 'file_type': 'wildcard_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'Testing white spaces'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'Testing white spaces')], 'log_format': 'syslog',
    ...
    {'location': os.path.join(temp_dir, 'cyware-testing', 'test.*'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'test.txt'),
               os.path.join(temp_dir, 'cyware-testing', 'test.log')],
     'log_format': 'syslog', 'file_type': 'wildcard_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'c*test.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'c1test.txt'),
               os.path.join(temp_dir, 'cyware-testing', 'c2test.txt'),
               os.path.join(temp_dir, 'cyware-testing', 'c3test.txt')], 'log_format': 'syslog',
     'file_type': 'wildcard_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'duplicated', 'duplicated.txt'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'duplicated', 'duplicated.txt')],
     'log_format': 'syslog', 'path_2': os.path.join(temp_dir, 'cyware-testing', 'duplicated', 'duplicated.txt'),
     'file_type': 'duplicated_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', r'file.log-%Y-%m-%d'),
     'files': [os.path.join(temp_dir, 'cyware-testing', r'file.log-%Y-%m-%d')], 'log_format': 'syslog',
     'file_type': 'single_file'},
    {'location': os.path.join(temp_dir, 'cyware-testing', 'multiple-logs', '*'),
     'files': [os.path.join(temp_dir, 'cyware-testing', 'multiple-logs', 'multiple')],
     'log_format': 'syslog', 'file_type': 'multiple_logs'}
]

if sys.platform != 'win32':
    for case in metadata:
        if case['location'] == os.path.join(temp_dir, 'cyware-testing', '*'):
            for value in file_structure:
                if value['folder_path'] == os.path.join(temp_dir, 'cyware-testing'):
            ...
            case['files'].append(os.path.join(temp_dir, 'cyware-testing', 'テスト.txt'))
            case['files'].append(os.path.join(temp_dir, 'cyware-testing', 'ИСПЫТАНИЕ.txt'))
            case['files'].append(os.path.join(temp_dir, 'cyware-testing', '测试.txt'))
            case['files'].append(os.path.join(temp_dir, 'cyware-testing', 'اختبار.txt'))

for value in file_structure:
    if value['folder_path'] == os.path.join(temp_dir, 'cyware-testing', 'multiple-logs'):
        for i in range(2000):
...
def test_location(location_file_date, get_files_list, create_file_structure_module, get_configuration,
    ...
    '''
    description: Check if the 'cyware-logcollector' monitors the log files specified in the 'location' tag.
        ...
        if file_type == 'single_file':
            ...
            try:
                ...
                if sys.platform == 'sunos5':
                    pytest.xfail(reason='Xfail due to issue: https://github.com/cyware/cyware/issues/10751')

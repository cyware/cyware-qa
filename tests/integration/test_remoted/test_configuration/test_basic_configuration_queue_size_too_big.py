...
brief: The 'cyware-remoted' program is the server side daemon that communicates with the agents.
       Specifically, this test will check that a warning message is produced when 'cyware-remoted'
...
def test_big_queue_size(get_configuration, configure_environment, restart_remoted, wait_for_remoted_start_log):
    '''
    description: Check that when 'cyware-remoted' sets the queue size too big(greater than 262144), a warning message

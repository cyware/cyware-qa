...
configurations = load_cyware_configurations(configurations_path, "test_allowed_ips_invalid",
...
def test_allowed_ips_invalid(get_configuration, configure_environment, restart_remoted):
    '''
    description: Check that 'cyware-remoted' fails when 'allowed-ips' has invalid values.

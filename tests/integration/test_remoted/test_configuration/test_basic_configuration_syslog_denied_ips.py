...
configurations_path = os.path.join(test_data_path, 'data', 'cyware_basic_configuration.yaml')
...
def test_denied_ips_syslog(get_configuration, configure_environment, restart_remoted, wait_for_remoted_start_log):
    '''
    description: Check that 'cyware-remoted' denied connection to the specified 'denied-ips'.
    ...
    expected_output:
        ...
        - Cyware remoted did not start as expected.

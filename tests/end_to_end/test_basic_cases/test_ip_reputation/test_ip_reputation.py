...
references:
    - https://github.com/cyware/cyware-automation/wiki/Cyware-demo:-Execution-guide#ip_reputation
    - https://documentation.cyware.khulnasoft.com/current/proof-of-concept-guide/block-malicious-actor-ip-reputation.html
tags:
    - demo
    - ip_reputation
    - lists
...
from cyware_testing.modules import TIER0, LINUX, WINDOWS

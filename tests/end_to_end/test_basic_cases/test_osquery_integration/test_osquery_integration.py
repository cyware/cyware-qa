...
references:
    - https://github.com/cyware/cyware-automation/wiki/Cyware-demo:-Execution-guide#osquery
    - https://documentation.cyware.khulnasoft.com/current/proof-of-concept-guide/integrate-osquery.html
    - https://documentation.cyware.khulnasoft.com/current/user-manual/capabilities/osquery.html#osquery

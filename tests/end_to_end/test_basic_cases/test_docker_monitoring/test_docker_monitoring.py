...
brief: This test will verify that the Docker module is working correctly. The Cyware module for Docker is a subscriber to
...
references:
    - https://github.com/cyware/cyware-automation/wiki/Cyware-demo:-Execution-guide#Docker
    - https://documentation.cyware.khulnasoft.com/current/proof-of-concept-guide/monitoring-docker.html
    - https://documentation.cyware.khulnasoft.com/current/container-security/docker-monitor/index.html#docker-monitor-index
...
@pytest.mark.skip(reason='https://github.com/cyware/cyware-qa/issues/3210')

...
brief: This test will verify that the integeration with Virustotal works correctly. Syscheck scans a directory for
       changes and make the cyware-integratord component query VirusTotal for threat results using the VirusTotal API.
       Once VirusTotal identifies a file as a threat, Cyware is configured to trigger an active response to remove the
...
references:
    - https://github.com/cyware/cyware-automation/wiki/Cyware-demo:-Execution-guide#-virustotal
    - https://documentation.cyware.khulnasoft.com/current/proof-of-concept-guide/detect-remove-malware-virustotal.html
    - https://documentation.cyware.khulnasoft.com/current/user-manual/capabilities/virustotal-scan/index.html#virustotal-scan

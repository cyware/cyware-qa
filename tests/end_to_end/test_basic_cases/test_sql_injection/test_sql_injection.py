...
brief: This test will verify that a SQL injection attack is detected correctly. Cyware is able to detect an SQL Injection
...
references:
    - https://github.com/cyware/cyware-automation/wiki/Cyware-demo:-Execution-guide#sql_injection
    - https://documentation.cyware.khulnasoft.com/current/proof-of-concept-guide/detect-web-attack-sql-injection.html
tags:
    - demo
    - sql_injection
'''

...
def validate_inventory(inventory_path, target_hosts):
    ...
    This function checks:
        ...
        2. If the hostnames follow our standard (<os>-<cyware-installation-type>)
    ...
    if missing_hosts != []:
        readme_file = '[README.md](https://github.com/cyware/cyware-qa/blob/master/tests/end_to_end/README.md)'
...
def get_indexer_credentials(request):
    """Get cyware-indexer username and password.

       Returns:
            dict: cyware-indexer credentials.
    """

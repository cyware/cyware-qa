...
from cyware_testing import CYWARE_PATH

AWS_MODULE_PATH = Path(CYWARE_PATH, 'wodles', 'aws')
...
PERMANENT_CLOUDWATCH_LOG_GROUP = 'cyware-cloudwatchlogs-integration-tests'

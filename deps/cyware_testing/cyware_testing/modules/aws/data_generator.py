...
from cyware_testing.tools.utils import get_random_ip, get_random_port, get_random_string
        ...
        return json.dumps(
            {
                ...
                'detail': {
                    ...
                    'actor': 'resources.cyware.khulnasoft.com',
                    'summary': {
                        'Description': 'S3 Bucket uses IAM policy to grant read rights to Everyone.',
                        'Bucket': {
                            'resources.cyware.khulnasoft.com': 1
                        },
                        'Record Count': 1,
                        'ACL': {
                            'resources.cyware.khulnasoft.com': [
                                {
                                    'Owner': {
                                        'DisplayName': 'cyware',
...
class ServerAccessDataGenerator(DataGenerator):
    ...
    def get_data_sample(self):
        ...
        for _ in range(5):
            data.append(
                [
                    str(uuid4()), 'cyware-server-access-integration-tests',
                    ...
                    'REST.GET.WEBSITE', '-', 'GET, /cyware-server-access-integration-tests?website= HTTP/1.1',

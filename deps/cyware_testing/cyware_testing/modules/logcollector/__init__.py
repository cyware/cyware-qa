import sys
from cyware_testing.tools.monitoring import LOG_COLLECTOR_DETECTOR_PREFIX, AGENT_DETECTOR_PREFIX


# Variables
LOG_COLLECTOR_PREFIX = AGENT_DETECTOR_PREFIX if sys.platform == 'win32' else LOG_COLLECTOR_DETECTOR_PREFIX
WINDOWS_AGENT_PREFIX = r'.*cyware-agent.*'
MAILD_PREFIX = r'.*cyware-maild.*'

...
# Yaml Configuration
YAML_CONF_REGISTRY_RESPONSE = 'cyware_conf_registry_responses_win32.yaml'
YAML_CONF_SYNC_WIN32 = 'cyware_sync_conf_win32.yaml'
YAML_CONF_MAX_EPS_SYNC = 'cyware_sync_conf_max_eps.yaml'

...
def callback_cywaredb_message_added_and_modified(item):
    data, _ = item
...
def callback_cyware_db_message_deleted(item):
    data, _ = item
...
def get_cyware_db_message(item, keyword: str = None):
    data, _ = item
...
def callback_cyware_db_message(item):
    if callback_cywaredb_message_added_and_modified(item) or callback_cyware_db_message_deleted(item):
        return get_cyware_db_message(item)


def callback_cyware_db_integrity(item):
    return get_cyware_db_message(item, keyword='integrity')


def callback_cyware_db_scan(item):
    return get_cyware_db_message(item, keyword='scan')

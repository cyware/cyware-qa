...
from cyware_testing.db_interface import query_wdb


def clean_table(agent_id, table):
    """Delete all table entries of the agent DB using cyware_db.
...
def insert_package(agent_id='000', scan_id=int(time()), format='rpm', name='custom-package-0',
                   priority='', section='Unspecified', size=99, vendor='cyware-mocking', version='1.0.0-1.el7',
                   architecture='x64', multiarch='', description='Cyware mocking packages', source='Cyware QA tests',

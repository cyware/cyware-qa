...
from cyware_testing.qa_docs.lib.config import Mode
from cyware_testing.qa_docs.lib.code_parser import CodeParser
from cyware_testing.qa_docs.lib.utils import clean_folder
from cyware_testing.qa_docs import QADOCS_LOGGER
from cyware_testing.tools.logging import Logging
from cyware_testing.tools.exceptions import QAValueError
from cyware_testing.qa_docs.lib.utils import get_file_path_recursively
...
class DocGenerator:
    ...
    The included paths are generated using the types and modules from the cyware-qa framework.
    ...
    def print_module_info(self, module):
        ...
        """
        relative_path = re.sub(r'.*cyware-qa\/', '', self.module_path)

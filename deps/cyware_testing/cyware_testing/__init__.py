...
if sys.platform == 'win32':
    ...
    SYSCOLLECTOR_DB_PATH = os.path.join(CYWARE_PATH, 'queue', 'syscollector', 'db', 'local.db')
else:
...
CYWARE_CONF_PATH = os.path.join(CYWARE_PATH, 'etc', 'ossec.conf')
CYWARE_LOGS_PATH = os.path.join(CYWARE_PATH, 'logs')
CLIENT_KEYS_PATH = os.path.join(CYWARE_PATH, 'etc' if platform.system() == 'Linux' else '', 'client.keys')
...
CVE_DB_PATH = os.path.join(CYWARE_PATH, 'queue', 'vulnerabilities', 'cve.db')
ALERTS_JSON_PATH = os.path.join(CYWARE_PATH, 'logs', 'alerts', 'alerts.json')
ARCHIVES_LOG_PATH = os.path.join(CYWARE_PATH, 'logs', 'archives', 'archives.log')
ARCHIVES_JSON_PATH = os.path.join(CYWARE_PATH, 'logs', 'archives', 'archives.json')
CPE_HELPER_PATH = os.path.join(CYWARE_PATH, 'queue', 'vulnerabilities', 'dictionaries', 'cpe_helper.json')
...
CYWARE_TESTING_PATH = os.path.dirname(os.path.abspath(__file__))
CIS_RULESET_PATH = os.path.join(CYWARE_PATH, 'ruleset', 'sca')
CYWARE_TESTING_DATA_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data')
DEFAULT_AUTHD_PASS_PATH = os.path.join(CYWARE_PATH, 'etc', 'authd.pass')
...
# Paths
SYSLOG_SIMULATOR = os.path.join(CYWARE_TESTING_PATH, 'scripts', 'syslog_simulator.py')
ANALYSISD_STATE = os.path.join(CYWARE_PATH, 'var', 'run', 'cyware-analysisd.state')

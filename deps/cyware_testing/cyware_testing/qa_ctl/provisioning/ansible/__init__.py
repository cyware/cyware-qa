...
from cyware_testing.qa_ctl.provisioning.ansible.unix_ansible_instance import UnixAnsibleInstance
from cyware_testing.qa_ctl.provisioning.ansible.windows_ansible_instance import WindowsAnsibleInstance

...
from cyware_testing import logger, REGULAR, SYMLINK, HARDLINK
...
def bind_unix_socket(socket_path, protocol='TCP'):
    ...
    By default it is assigned owner and group cyware and permissions 660.
    ...
    if not os.path.exists(socket_path) and sys.platform != 'win32':
        ...
        set_file_owner_and_group(socket_path, 'cyware', 'cyware')

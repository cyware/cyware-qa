...
class DataVisualizer:
    """Class that allows to visualize the data collected using the cyware_metrics tool.
    ...
    def _plot_analysisd_dataset(self):
        """Function to plot the statistics from cyware-analysisd."""
    ...
    def _plot_remoted_dataset(self):
        """Function to plot the statistics from cyware-remoted."""
    ...
    def _plot_agentd_dataset(self):
        """Function to plot the statistics from cyware-agentd."""
    ...
    def _get_daemons(self):
        """Get the list of Cyware Daemons in the dataset."""

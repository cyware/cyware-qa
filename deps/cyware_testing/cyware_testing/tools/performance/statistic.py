...
import cyware_testing.tools as tls

logger = logging.getLogger('cyware-statistics-monitor')
logger.setLevel(logging.INFO)


class StatisticMonitor:
    """This class generates a Python object to monitor the statistics file generated by Cyware.

    There are four files: cyware-analysisd.state, cyware-remoted.state, cyware-agentd.state and cyware-logcollector.state
    ...
    def _parse_classic_state_file(self, data):
        """Parse the info from the .state files from Cyware with shell compatible format.
    ...
    def _parse_state_file(self):
        """Read the data from the statistics file generated by Cyware."""
        try:

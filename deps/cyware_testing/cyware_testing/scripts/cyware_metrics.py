...
from cyware_testing.tools.performance.binary import Monitor, logger
...
def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Cyware processes metrics",
...
def main():
    ...
    logging.basicConfig(filename=join(METRICS_FOLDER, 'cyware-metrics.log'), filemode='a',

...
"""
Version: 1.0
Tool documentation: https://github.com/cyware/cyware-qa/wiki/Stress-results-comparator-tool
...
MANAGER_DAEMON_LIST = ['remoted', 'analysisd', 'cyware-db', 'cyware-authd', 'clusterd', 'monitord',
...
def process_dataframes(parameters):
    ...
    filtered_dataframes = [dataframe[dataframe['Daemon'] == f"cyware-{parameters.selected_daemon}"] for dataframe
                           in dataframes]

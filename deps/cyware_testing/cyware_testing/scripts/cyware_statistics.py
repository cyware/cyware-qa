...
from cyware_testing.tools.performance.statistic import StatisticMonitor, logger

METRICS_FOLDER = join(gettempdir(), 'cyware_statistics')
...
def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Cyware statistics collector",
...
def main():
    ...
    logging.basicConfig(filename=join(METRICS_FOLDER, 'cyware-statistics.log'), filemode='a',

...
from cyware_testing.tools.performance.binary import ClusterLogParser, APILogParser
...
def get_script_arguments():
    ...
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Cyware log parser",
